<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="LichSuDoc.aspx.cs" Inherits="Admin_Page_News.Home.WebForm8" %>
      ...
      <div class="row justify-content-center">
        <div class=" p-b-20  ">
          <div class=" how2 how2-cl4 flex-s-c m-r-10 m-r-0-sr991">
            <h3 class="f1-m-2 cl3 tab01-title"> LỊCH SỬ ĐỌC </h3>
            
          </div>    
          <div class="row p-t-35">
              

            <asp:ListView ID="LV_News_All" runat="server" DataKeyNames="News_ID" OnPagePropertiesChanging="LV_News_All_PagePropertiesChanging"  OnItemCommand="LV_News_All_ItemCommand" >
