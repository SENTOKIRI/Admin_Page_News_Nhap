<%@ Page Title="" Language="C#" MasterPageFile="~/Content_Creator/ContentCreator.Master" AutoEventWireup="true" CodeBehind="User_Infor.aspx.cs" Inherits="Admin_Page_News.Content_Creator.WebForm4" %>
                ...
                <div class="row m-t-10">
                    <div class="col-md-4">
                        ...
                        <div>
                            ...
                            <asp:Button ID="Btn_taobaiviet" runat="server" CssClass="btn btn-outline-dark thaotac m-t-5 " Text="Tạo bài viết mới" OnClick="Btn_taobaiviet_Click" />
                            <asp:Button ID="Btn_dsbaiviet" runat="server" CssClass="btn btn-outline-dark thaotac m-t-5 " Text="Danh sách tin" OnClick="Btn_dsbaiviet_Click" />
                        </div>
