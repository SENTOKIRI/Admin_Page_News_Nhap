...
namespace Admin_Page_News.Content_Creator
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Btn_taobaiviet_Click(object sender, EventArgs e)
        {
            Response.Redirect("../Content_Creator/create_news.aspx");

        }
        protected void Btn_dsbaiviet_Click(object sender, EventArgs e)
        {
