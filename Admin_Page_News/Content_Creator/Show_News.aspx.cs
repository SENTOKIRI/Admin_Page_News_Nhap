...
namespace Admin_Page_News.Content_Creator
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void Bt_Sua_News_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/Content_Creator/create_news?News_ID=" + strId);
        ...
        public void loaddatalienquan()
        {
            ...
            queryId = Convert.ToInt32(Session["iduser"]);
            if (queryId > 0)
            {

                List<Obj_News> lstnewsLQ = Dao_News.getIDUserNewsTest(queryId);
        ...
        //    {
        //        SqlCommand cmd = new SqlCommand
        //       ("insert into TB_Comment(CM_Comment,News_ID,User_ID,CM_Email,CM_Rep) values (@CM_Comment,@News_ID,@User_ID,@CM_Email,'v')", conn);

        //        conn.Open();
        //        cmd.Parameters.AddWithValue("@CM_Comment", Tb_Comment_Test.Text.ToString());
