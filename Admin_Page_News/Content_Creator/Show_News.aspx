<%@ Page Title="" Language="C#" MasterPageFile="~/Content_Creator/ContentCreator.Master" AutoEventWireup="true" CodeBehind="Show_News.aspx.cs" Inherits="Admin_Page_News.Content_Creator.WebForm3" %>
            ...
            <div class="post-meta">
              ...
              <div class="post-meta flex-row-reverse">
                 <span >
                    ...
                    <asp:LinkButton ID="Lb_User_Name" runat="server" ></asp:LinkButton>
                </span>
              </div>
        ...
        <div class="post-body">
         ...
         <div class="share-block  d-flex justify-content-between align-items-center border-top border-bottom mt-5">
            <div class="post-tags">
               ...
               <asp:LinkButton ID="LB_Tag" runat="server" CssClass="tag-style Color" Text='<%#Eval("Tag_Name")%>' >LinkButton</asp:LinkButton>  
           </div>
            <asp:Button ID="Btn_luu" runat="server"  CssClass="flex-c-c size-h-2 bo-1-rad-20 bocl12 f1-s-1 cl8 btn-outline-danger trans-03 p-rl-10 p-tb-5 m-all-5" Text="Lưu" />
           
        </div>
                     
                   <asp:Button ID="Button1" runat="server" Text="Sửa"  CssClass="btn btn-outline-primary m-b-15" Width="100%"  OnClick="Bt_Sua_News_Click"/>
            ...
            <div class="item">
                <div class="post-block-wrapper clearfix">
                    <div class="post-thumbnail mb-0" >
                        <a href="../Content_Creator/Show_News?News_ID=<%#Eval("News_ID")%>">
